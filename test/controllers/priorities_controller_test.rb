...
class PrioritiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create priority" do
    assert_difference('Priority.count') do
      post priorities_url, params: { priority: { existing_customers: @priority.existing_customers, feature_id: @priority.feature_id, name: @priority.name, new_sales: @priority.new_sales, strategic: @priority.strategic } }
    end
  ...
  test "should update priority" do
    patch priority_url(@priority), params: { priority: { existing_customers: @priority.existing_customers, feature_id: @priority.feature_id, name: @priority.name, new_sales: @priority.new_sales, strategic: @priority.strategic } }

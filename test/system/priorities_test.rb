...
class PrioritiesTest < ApplicationSystemTestCase
  ...
  test "creating a Priority" do
    ...
    fill_in "Existing customers", with: @priority.existing_customers
    fill_in "Feature", with: @priority.feature_id
    fill_in "Name", with: @priority.name
    fill_in "New sales", with: @priority.new_sales
    fill_in "Strategic", with: @priority.strategic
